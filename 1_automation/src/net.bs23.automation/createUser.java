...
public class EcomSignUp {
 ...
 public static void main(String[] args) {
  ...
  //Enter email address
  driver.findElement(By.cssSelector("[name='email_create']")).sendKeys("test1@test.com");
  ...
  if(userText.contains("Vsoft")) {
   System.out.println("User Verified,Test case1Passed");
  }
  else {
   System.out.println("User Verification Failed,Test case1 Failed");
  }
    {//Click on Sign out
  ...
  //Enter email address
  driver.findElement(By.cssSelector("[name='email_create']")).sendKeys("test2@test.com");
  ...
  //Select Title
  driver.findElement(By.xpath("//input[@id=\"id_gender1\"]")).click();
  driver.findElement(By.name("customer_firstname")).sendKeys("Test User a");
  driver.findElement(By.name("customer_lastname")).sendKeys("Vsoft b");
  driver.findElement(By.id("passwd")).sendKeys("PKR@PKR");
  
  // Enter your address
  driver.findElement(By.id("firstname")).sendKeys("Test User a");
  driver.findElement(By.id("lastname")).sendKeys("Vsofta");
  driver.findElement(By.id("company")).sendKeys("Vsoft");
  driver.findElement(By.id("address1")).sendKeys("Test 81/1,2nd cross");
  driver.findElement(By.id("city")).sendKeys("XYZ");
  ...
  // Validate that user has created
  if(userText.contains("Vsoft")) {
   System.out.println("User Verified,Test case2 Passed");
  }
  else {
   System.out.println("User Verification Failed,Test case2 Failed");
  }
